...
export interface WorkerInterface {
   ...
   * Automatically generated if undefined in the range [0, 1].
   * (-1 reserved)
   */
  interactionID?: number,
}

export interface WorkerSubscriptionInterface<O extends WorkerInterface> {
  target: string,
  callback: (output: O["value"], interactionID?: number) => void,
}
...
export function useWorker
  <
    ...
    S extends WorkerSubscriptionInterface<O>
  >
  (
